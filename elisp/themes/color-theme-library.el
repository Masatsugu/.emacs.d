...
;     (font-lock-comment-face ((t (:foreground "#888a85" :slant italic :background "#2f4f4f"))))
     (font-lock-comment-face ((t (:foreground "SpringGreen2"))))      
     (font-lock-comment-delimiter-face ((t (:foreground "SpringGreen2" :slant italic))))
     ...
     (font-lock-preprocessor-face ((t (:foreground "#2ea6e2"))))
     ...
     (isearch ((t (:foreground "#ffffff" :background "gold3"))))
     (isearch-fail ((t (:foreground "#FFFFFF" :background "#333333"))))
     (lazy-highlight ((t (:foreground "#465457" :background "gold1"))))
